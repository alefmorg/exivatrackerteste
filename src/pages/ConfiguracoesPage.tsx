...
import { Plus, Globe, Users, Trash2, RefreshCw, Search, Settings, User, Shield, Save, LogOut, Mail, Key, Clock, Zap, Bell, Database, Monitor, Eye, EyeOff, ChevronDown, ChevronUp, AlertTriangle, Check, Volume2, VolumeX, Sun, Moon, Layout, Columns, List, Grid3X3, Paintbrush, Image, X, RotateCcw } from 'lucide-react';
...
import { loadSettings, saveSettings, applyTheme, type AppSettings, type IconPack, DEFAULT_SETTINGS } from '@/hooks/useSettings';
